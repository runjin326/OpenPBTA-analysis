...
We'll only include a subset of the mappings in the README (those that we think require the most explanation).

```{r}
# We print out this table in order to have a table of the mappings between the 
# harmonized dx and cancer group
histology %>% 
