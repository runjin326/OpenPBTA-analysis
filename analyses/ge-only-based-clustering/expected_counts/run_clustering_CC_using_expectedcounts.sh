...
-l initial_hgat_histology.tsv -d "spearman" -a "hc" \
...
# euclidean HC
Rscript code/04-clustering-CC.R --cohort_id "initial_hgat" -p "Kids_First_Biospecimen_ID"   \
-l initial_hgat_histology.tsv -d "euclidean" -a "hc" \
...
# euclidian PAM
Rscript code/04-clustering-CC.R --cohort_id "initial_hgat" -p "Kids_First_Biospecimen_ID"   \
-l initial_hgat_histology.tsv -d "euclidean" -a "pam" \
...
# manhattan PAM
Rscript code/04-clustering-CC.R --cohort_id "initial_hgat" -p "Kids_First_Biospecimen_ID"   \
-l initial_hgat_histology.tsv -d "manhattan" -a "pam" \
...
# manhattan HC
Rscript code/04-clustering-CC.R --cohort_id "initial_hgat" -p "Kids_First_Biospecimen_ID"   \
-l initial_hgat_histology.tsv -d "manhattan" -a "hc" \
